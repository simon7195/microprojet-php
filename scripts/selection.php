...
<p class="card-text">
<a class="badge badge-primary" data-toggle="collapse" href="#biographie-'.$key.'" role="button" aria-expanded="false" aria-controls="biographie-'.$key.'">
Lire la bio
</a></p>
<div class="collapse" id="biographie-'.$key.'">'.$bio[$key].'</div>
</div>
</div>';
}
